            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4">
                 ...
                 <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="date" name="birthdate" class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value="{{ old('birthdate') }}">
                        <x-input-error :messages="$errors->get('birthdate')" class="mt-2" />
                    </div>
                </div>
                <!-- Nuevo campo para foto de perfil -->
                <div class="sm:col-span-3">
                    <label for="profile_photo" class="block text-md font-medium leading-6 text-gray-900">Foto de Perfil</label><div class="mt-2">
